...
Page({
  ...
  locationCorrect: function (latitude, longitude) {
    ...
    //访问 web 端百度 API 经纬度转换方法
    //访问页面所需要提供的参数 
    var params = {
      from: 1,
      to: 5,
      coords: longitude + "," + latitude, 
      ak: "YQgDI5WeASwt5BX0DFWDy1wIz0bNmduG" //百度网页端服务 AK
    }
    //调用微信访问 url 方法
    wx.request({
      url: url,
  ...
  getCity: function (latitude, longitude) {
    ...
    var params = {
      ak: "4kkqi2BSAO6PGcVwKITmC35jH1TuYgyG",//百度网页端服务 AK(貌似微信小程序 AK 也行) 
      output: "json",
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        var street = res.data.result.addressComponent.street;//街道信息 //渲染到 wxml 页面中
        that.setData({
  ...
  getWeahter: function (city) {
    ...
    var params = {
      location: city,
      output: "json",
      ak: "4kkqi2BSAO6PGcVwKITmC35jH1TuYgyG"//百度微信小程序 AK 
    }
    wx.request({
      url: url,
      data: params,
